...
const getAHParentInteractions = async (req, res) => {
    try {
        const [rows] = await db.query(`
            ...
            JOIN users u ON p.academic_operation_executive_id = u.id
...
const createAHParentInteraction = async (req, res) => {
    try {
        ...
        const academic_operation_executive_id = req.user.id;
        await db.query(`
            INSERT INTO ah_parent_interactions (student_id, academic_operation_executive_id, date, interaction_data, notes)
            VALUES (?, ?, ?, ?, ?)
        `, [student_id, academic_operation_executive_id, date, JSON.stringify(interaction_data || {}), notes || '']);
...
const getAHFacultyInteractions = async (req, res) => {
    try {
        const [rows] = await db.query(`
            ...
            JOIN users u ON f.academic_operation_executive_id = u.id
...
const createAHFacultyInteraction = async (req, res) => {
    try {
        ...
        const academic_operation_executive_id = req.user.id;
        await db.query(`
            INSERT INTO ah_faculty_interactions (faculty_id, academic_operation_executive_id, date, interaction_data, notes)
            VALUES (?, ?, ?, ?, ?)
        `, [faculty_id, academic_operation_executive_id, date, JSON.stringify(interaction_data || {}), notes || '']);
...
const getAHParentMeetings = async (req, res) => {
    try {
        const [rows] = await db.query(`
            ...
            JOIN users u ON m.academic_operation_executive_id = u.id
...
const scheduleAHParentMeeting = async (req, res) => {
    try {
        ...
        const academic_operation_executive_id = req.user.id;
        await db.query(`
            INSERT INTO ah_parent_meetings (student_id, academic_operation_executive_id, meeting_date, meeting_time, status, meeting_link, notes)
            VALUES (?, ?, ?, ?, 'Scheduled', ?, ?)
        `, [student_id, academic_operation_executive_id, meeting_date, meeting_time, meeting_link || '', notes || '']);
