        ...
        let query = `
            SELECT * FROM (
                (SELECT 
                    ...
                    CAST(sil.mentor_notes AS CHAR) CHARACTER SET utf8mb4 as mentor_notes,
                    CAST(COALESCE(s.name, 'Unknown Student') AS CHAR) CHARACTER SET utf8mb4 as student_name,
                    CAST(COALESCE(m.name, 'Unknown Mentor') AS CHAR) CHARACTER SET utf8mb4 as mentor_name,
                    CAST(sil.mentor_id AS CHAR) as mentor_id,
                    CAST(COALESCE(m.place, 'N/A') AS CHAR) CHARACTER SET utf8mb4 as mentor_place,
                    CAST('Quick Log' AS CHAR) CHARACTER SET utf8mb4 as type,
                    CAST('Quick Log' AS CHAR) CHARACTER SET utf8mb4 as source,
                ...
                (SELECT 
                    ...
                    CAST(CONCAT(msl.main_issue, ': ', msl.action_type) AS CHAR) CHARACTER SET utf8mb4 as mentor_notes,
                    CAST(COALESCE(s.name, 'Unknown Student') AS CHAR) CHARACTER SET utf8mb4 as student_name,
                    CAST(COALESCE(m.name, 'Unknown Mentor') AS CHAR) CHARACTER SET utf8mb4 as mentor_name,
                    CAST(msl.mentor_id AS CHAR) as mentor_id,
                    CAST(COALESCE(m.place, 'N/A') AS CHAR) CHARACTER SET utf8mb4 as mentor_place,
                    CAST('Session Log' AS CHAR) CHARACTER SET utf8mb4 as type,
                    CAST('Session Log' AS CHAR) CHARACTER SET utf8mb4 as source,
                ...
                (SELECT 
                    ...
                    CAST(JSON_UNQUOTE(JSON_EXTRACT(msr.report_data, '$.notes')) AS CHAR) CHARACTER SET utf8mb4 as mentor_notes,
                    CAST(COALESCE(s.name, 'Unknown Student') AS CHAR) CHARACTER SET utf8mb4 as student_name,
                    CAST(COALESCE(m.name, 'Unknown Mentor') AS CHAR) CHARACTER SET utf8mb4 as mentor_name,
                    CAST(msr.mentor_id AS CHAR) as mentor_id,
                    CAST(COALESCE(m.place, 'N/A') AS CHAR) CHARACTER SET utf8mb4 as mentor_place,
                    CAST(CONCAT('Hub: ', msr.session_type) AS CHAR) CHARACTER SET utf8mb4 as type,
                    CAST('Interaction Hub' AS CHAR) CHARACTER SET utf8mb4 as source,
                ...
                (SELECT 
                    ...
                    CAST(ml.action_details AS CHAR) CHARACTER SET utf8mb4 as mentor_notes,
                    CAST(COALESCE(s.name, 'Unknown Student') AS CHAR) CHARACTER SET utf8mb4 as student_name,
                    CAST(COALESCE(m.name, 'Unknown Mentor') AS CHAR) CHARACTER SET utf8mb4 as mentor_name,
                    CAST(ml.mentor_id AS CHAR) as mentor_id,
                    CAST(COALESCE(m.place, 'N/A') AS CHAR) CHARACTER SET utf8mb4 as mentor_place,
                    CAST('Mentorship' AS CHAR) CHARACTER SET utf8mb4 as type,
                    CAST('Mentorship' AS CHAR) CHARACTER SET utf8mb4 as source,
                ...
                (SELECT 
                    ...
                    CAST(mfi.main_issue AS CHAR) CHARACTER SET utf8mb4 as mentor_notes,
                    CAST(COALESCE(s.name, 'Unknown Student') AS CHAR) CHARACTER SET utf8mb4 as student_name,
                    CAST(COALESCE(m.name, 'Unknown Mentor') AS CHAR) CHARACTER SET utf8mb4 as mentor_name,
                    CAST(mfi.mentor_id AS CHAR) as mentor_id,
                    CAST(COALESCE(m.place, 'N/A') AS CHAR) CHARACTER SET utf8mb4 as mentor_place,
                    CAST('Faculty Call' AS CHAR) CHARACTER SET utf8mb4 as type,
                    CAST('Faculty Interaction' AS CHAR) CHARACTER SET utf8mb4 as source,
                    NULL as understanding_level,
                    NULL as student_confidence,
                    NULL as stress_level,
                    mfi.created_at
                ...
                (SELECT 
                    ...
                    CAST(fil.notes AS CHAR) CHARACTER SET utf8mb4 as mentor_notes,
                    CAST(COALESCE(s.name, 'Unknown Student') AS CHAR) CHARACTER SET utf8mb4 as student_name,
                    CAST(COALESCE(m.name, 'Unknown Mentor') AS CHAR) CHARACTER SET utf8mb4 as mentor_name,
                    CAST(fil.mentor_id AS CHAR) as mentor_id,
                    CAST(COALESCE(m.place, 'N/A') AS CHAR) CHARACTER SET utf8mb4 as mentor_place,
                    CAST('Faculty Tracking' AS CHAR) CHARACTER SET utf8mb4 as type,
                    CAST('Faculty Tracking' AS CHAR) CHARACTER SET utf8mb4 as source,
                    NULL as understanding_level,
                    NULL as student_confidence,
                    NULL as stress_level,
                    fil.created_at
