        ...
        <div className="max-w-4xl mx-auto">
            <div className="bg-white rounded-[3rem] border border-slate-100 shadow-xl overflow-hidden flex flex-col md:flex-row">
                ...
                <div className="md:w-2/5 bg-indigo-600 p-12 text-white flex flex-col justify-between relative overflow-hidden">
                    <div className="absolute top-0 right-0 -mr-20 -mt-20 w-64 h-64 bg-indigo-500 rounded-full blur-3xl opacity-50 animate-pulse"></div>
                    <div className="absolute bottom-0 left-0 -ml-20 -mb-20 w-64 h-64 bg-indigo-700 rounded-full blur-3xl opacity-50 animate-pulse delay-700"></div>
                    ...
                    <div className="relative z-10">
                        ...
                        <p className="text-indigo-100 text-sm font-bold uppercase tracking-widest leading-relaxed">
                    ...
                    <div className="relative z-10 mt-12 bg-white/5 backdrop-blur-sm p-6 rounded-[2rem] border border-white/10">
                        <div className="flex items-center gap-4 mb-4">
                            <div className="w-8 h-8 rounded-full bg-emerald-400 flex items-center justify-center text-indigo-900">
                                <ShieldCheck size={16} />
                            </div>
