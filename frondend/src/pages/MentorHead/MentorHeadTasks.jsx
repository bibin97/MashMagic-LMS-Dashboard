            ...
            <div className="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm overflow-hidden flex flex-col min-h-[500px]">
                <div className="flex flex-col sm:flex-row justify-between items-center p-8 border-b border-slate-100 gap-4">
                    <div className="relative w-full sm:w-80 group">
                        <AlertTriangle size={18} className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-indigo-500 transition-colors" />
                        <input
                            type="text"
                            placeholder="Scan protocols by title..."
                            className="w-full bg-slate-50 border border-slate-100 rounded-2xl py-3 pl-12 pr-4 text-xs font-bold outline-none focus:bg-white focus:ring-4 focus:ring-indigo-50/50 focus:border-indigo-200 transition-all placeholder:text-slate-400"
                            value={searchQuery}
                        ...
                        <div className="flex bg-slate-100 p-1 rounded-xl">
                            {['All', 'Pending', 'Completed'].map(s => (
                                <button 
                                    ...
                                    className={`px-4 py-1.5 rounded-lg text-[10px] font-black uppercase tracking-widest transition-all ${statusFilter === s ? 'bg-white text-indigo-600 shadow-sm' : 'text-slate-500 hover:text-slate-800'}`}
                                >
                                    {s}
                                </button>
                            ))}
                                        ...
                                        <tr key={task.id} className="hover:bg-slate-50/50 transition-all group">
                                            <td className="p-6">
                                                <div className="flex items-center gap-4">
                                                    ...
                                                    <div>
                                                        <span className="text-xs font-black text-slate-900 block group-hover:text-indigo-600 transition-colors uppercase tracking-tight">{task.title}</span>
                                                ...
                                                <div className="flex items-center justify-end gap-2 opactiy-0 group-hover:opacity-100 transition-opacity">
                                                    ...
                                                    {task.status !== 'Completed' && (
                                                        <button
                                                            ...
                                                            className="h-10 px-4 rounded-xl flex items-center justify-center gap-2 bg-indigo-50 text-indigo-600 hover:bg-indigo-600 hover:text-white transition-all shadow-sm shadow-indigo-100 active:scale-95 font-black text-[10px] uppercase tracking-widest"
                                                        >
                                                            <CheckCircle size={14} />
                                                            Identify Solved
                                                        </button>
                ...
                <div className="p-6 bg-slate-50/50 border-t border-slate-100 flex justify-between items-center mt-auto">
                    ...
                    <div className="flex gap-2">
                        ...
                        <button className="px-4 py-2 bg-indigo-600 text-white rounded-xl text-[10px] font-black uppercase tracking-widest shadow-lg shadow-indigo-100 italic">Page 01</button>
