                    ...
                    <form onSubmit={submitStudent} className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="flex flex-col gap-2">
                                ...
                                <input type="text" name="name" required value={studentForm.name} onChange={handleStudentChange} className="w-full p-3 bg-slate-50 border border-slate-100 rounded-xl text-sm outline-none focus:bg-white focus:ring-2 focus:ring-indigo-100 font-bold" placeholder="Full Name" />
                            </div>
                            <div className="flex flex-col gap-2">
                                <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Grade (1-12)</label>
                                <select name="grade" required value={studentForm.grade} onChange={handleStudentChange} className="w-full p-3 bg-slate-50 border border-slate-100 rounded-xl text-sm outline-none focus:bg-white focus:ring-2 focus:ring-indigo-100 font-bold appearance-none">
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <input type="text" name="hour" required value={studentForm.hour} onChange={handleStudentChange} className="w-full p-3 bg-slate-50 border border-slate-100 rounded-xl text-sm outline-none focus:bg-white focus:ring-2 focus:ring-indigo-100 font-bold" placeholder="e.g. 10:00 AM - 11:00 AM" />
                            </div>
                            <div className="flex flex-col gap-2">
                            ...
                            <div className="md:col-span-2 bg-indigo-50/50 p-4 rounded-xl border border-indigo-100 flex items-start gap-4">
                                ...
                                <div>
                                    <h3 className="text-xs font-black text-indigo-900 uppercase tracking-widest mb-1">Weekly Time Table</h3>
                                    <p className="text-[10px] font-bold text-indigo-500 uppercase">Note: Timetable will be filled automatically after the first class is completed.</p>
                                </div>
                            </div>
                        </div>
