                                                ...
                                                <td className="px-8 py-6 text-right">
                                                    <div className="flex items-center justify-end gap-2">
                                                        <button
                                                            ...
                                                            className={`p-2.5 rounded-xl border transition-all ${isChecked ? 'bg-emerald-600 border-emerald-600 text-white shadow-lg shadow-emerald-100' : 'bg-white border-slate-200 text-slate-400 hover:text-indigo-600 hover:border-indigo-200 shadow-sm'}`}
                                                        >
                                                            <Check size={18} />
                                                        </button>
                                                        {isChecked && (
                                    ...
                                    {pendingLogs.map(log => (
                                        <tr key={log.id} className="hover:bg-slate-50/50 transition-colors">
                                            ...
                                            <td className="px-8 py-6">
                                                ...
                                                <p className="text-xs font-bold text-indigo-600 mt-1">{log.student_name || 'N/A'}</p>
                                            </td>
                                            ...
                                            <td className="px-8 py-6 text-right">
                                                <button
                                                    ...
                                                    className="inline-flex items-center justify-center w-10 h-10 bg-white border border-slate-200 rounded-xl text-slate-400 hover:text-indigo-600 hover:border-indigo-200 hover:bg-indigo-50 shadow-sm transition-all"
                                                >
                                                    <CheckCircle size={18} />
                                                </button>
                                            </td>
                    ...
                    <div className="bg-white rounded-[3rem] w-full max-w-lg shadow-2xl overflow-hidden relative z-10 animate-in zoom-in duration-300">
                        ...
                        <form onSubmit={handleEvalSubmit} className="p-10 space-y-6">
                            ...
                            <div>
                                ...
                                <textarea
                                    className="w-full p-4 bg-slate-50 border border-slate-100 rounded-2xl text-sm font-bold shadow-sm outline-none focus:ring-4 focus:ring-indigo-50 min-h-[100px]"
                            ...
                            <div className="flex gap-4 pt-4">
                                <button type="submit" className="flex-1 bg-indigo-600 text-white py-4 rounded-2xl font-black text-xs uppercase tracking-widest shadow-xl shadow-indigo-200 hover:bg-indigo-700 transition-all">Save Evaluation</button>
...
const CheckboxItem = ({ label, checked, onChange }) => (
    <div className="flex justify-between items-center p-3 bg-slate-50 rounded-xl border border-slate-100 cursor-pointer hover:bg-indigo-50/50 transition-all" onClick={() => onChange(!checked)}>
        <span className="text-xs font-bold text-slate-700">{label}</span>
        <div className={`w-5 h-5 rounded flex items-center justify-center transition-all ${checked ? 'bg-indigo-600 text-white' : 'bg-slate-200'}`}>
