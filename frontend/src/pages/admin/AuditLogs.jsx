...
const AuditLogs = () => {
  ...
  return (
    <div className="space-y-6 md:space-y-10 animate-in fade-in duration-700 pb-20">
      ...
      {/* DESKTOP HEADER */}
      <header className="hidden md:flex bg-white p-10 md:p-14 rounded-[3.5rem] border border-slate-100 shadow-sm flex-col md:flex-row justify-between items-center gap-10">
        <div>
      ...
      <div className="md:hidden flex flex-col gap-4 px-2">
        {loading ? (
          ...
          // EMPTY STATE
          <div className="bg-white rounded-[2rem] p-8 border border-slate-100 shadow-sm flex flex-col items-center text-center mt-4">
