...
import { 
  Users, Calendar, Clock, Video, Presentation, CheckCircle2, ListTodo
} from 'lucide-react';
            ...
            {activeTab === 'active' && (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {activeMeetings.length === 0 ? (
                  <div className="col-span-full bg-white rounded-3xl p-12 border border-slate-100 shadow-sm text-center">
