...
const MentorRegistration = () => {
 ...
 className="w-full pl-14 pr-6 py-5 bg-slate-50 border-none rounded-[1.5rem] text-sm font-bold tracking-wide focus:ring-2 ring-[#008080]/20 transition-all outline-none"
 value={formData.name}
