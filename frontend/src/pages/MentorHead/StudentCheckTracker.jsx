...
const StudentCheckTracker = () => {
 ...
 className="bg-white border-none rounded-xl px-4 py-2 text-xs font-bold text-slate-700 outline-none cursor-pointer focus:ring-2 focus:ring-[#008080]/20 shadow-sm"
 >
