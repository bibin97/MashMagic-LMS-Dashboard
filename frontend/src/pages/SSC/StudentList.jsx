      ...
      <div className="flex items-center gap-3 w-full lg:w-auto shrink-0" onClick={(e) => e.stopPropagation()}>
        {isPending ? (
          ...
          <>
            ...
            <button
              onClick={() => navigate('/ssc/interaction-logs', { state: { studentId: student.id } })}
...
const SSCStudentList = () => {
 ...
 {/* Page Header */}
  ...
  <h2 className="text-5xl font-black text-slate-900 tracking-tighter leading-none mb-3 ">SSC Student List</h2>
  ...
  Global tracking & student success coordination
  </p>
  </div>
 ...
 <div className="px-10 py-8 border-b border-slate-100 flex justify-between items-center bg-white">
          <div>
            <h1 className="text-3xl font-black text-slate-900 tracking-tighter uppercase ">Activation Setup</h1>
            <p className="text-[10px] font-bold text-slate-600 uppercase tracking-[0.2em] mt-1">Initialize Timetable for {selectedStudent?.name}</p>
          </div>
