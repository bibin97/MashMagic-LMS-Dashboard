...
const StudentRow = ({ student, navigate }) => {
  ...
  return (
    <div
      ...
      className={`group relative bg-white border border-slate-100 rounded-[2rem] p-6 flex flex-col lg:flex-row items-center gap-8 transition-all duration-500 hover:shadow-2xl hover:-translate-y-1 cursor-pointer ${isPending ? 'border-amber-100 bg-amber-50/10' : ''}`}
    >
      ...
      {/* Navigation Arrow */}
      <div className="hidden lg:flex items-center justify-center w-12 h-12 bg-white rounded-2xl border border-slate-100 group-hover:bg-slate-900 group-hover:text-white transition-all">
