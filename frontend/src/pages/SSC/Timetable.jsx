    ...
    <div className="space-y-8 pb-20 max-w-[1600px] mx-auto min-h-screen">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 bg-white p-8 rounded-[2.5rem] shadow-sm border border-slate-100 border-b-4 border-b-[#008080]">
        <div className="flex items-center gap-5">
          ...
          <div>
            <h1 className="text-3xl font-black text-slate-900 tracking-tighter uppercase ">SSC Timetable Area</h1>
            <p className="text-[10px] font-bold text-slate-600 uppercase tracking-[0.2em] mt-1">Operational Control for Global Student Timelines</p>
          </div>
        </div>
