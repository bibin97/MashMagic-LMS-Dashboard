            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="relative group">
                  ...
                  <input type="text" name="hourly_rate" value={formData.hourly_rate} onChange={handleChange} className="w-full p-3 pl-10 bg-slate-50 border border-slate-100 rounded-xl text-sm font-bold text-black focus:bg-white focus:ring-2 focus:ring-[#008080] outline-none" placeholder="e.g. 500, 600" />
                </div>
              </div>
