    ...
    return (
        <div className="space-y-12">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center gap-8">
                <div>
                    <h2 className="text-3xl font-black text-slate-900 tracking-tighter uppercase italic">Notification Centre</h2>
            ...
            <div className="space-y-6">
                {loading ? (
                        ...
                        >
                            ...
                            <div className="flex items-start gap-8">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-slate-600 text-sm font-medium leading-relaxed max-w-3xl italic">
                                        "{notif.message}"
                                    </p>
                    ...
                    <div className="py-40 text-center bg-white rounded-[4rem] border border-slate-100 shadow-sm">
                        ...
                        <h3 className="text-2xl font-black text-slate-900 tracking-tight italic">Frequency Silent</h3>
