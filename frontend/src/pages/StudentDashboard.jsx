...
const StudentDashboard = () => {
 ...
 <span className="text-[11px] font-black text-slate-600 uppercase tracking-[0.2em] leading-none">Status: Mission Active</span>
 </div>
 </div>
 ...
 <span className="text-3xl font-black text-white tracking-tighter">{myUpdates.length}</span>
 </div>
