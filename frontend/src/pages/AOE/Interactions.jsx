...
import { 
  Users, UserPlus, FileText, PlusCircle, Search, Save, 
...
const Interactions = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setFormData({ ...formData, notes: '', interaction_data: {} });
    ...
    <div className="min-h-screen bg-slate-50/50 p-4 md:p-8">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex gap-4 border-b border-slate-200">
          <button
            onClick={() => { setActiveMainTab('parent'); setFormData({...formData, targetId: ''}); }}
            className={`pb-4 px-2 font-black uppercase text-xs tracking-widest transition-all ${
          ...
          <button
            onClick={() => { setActiveMainTab('faculty'); setFormData({...formData, targetId: ''}); }}
            className={`pb-4 px-2 font-black uppercase text-xs tracking-widest transition-all ${
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <select 
                    ...
                    className="w-full h-12 px-4 rounded-xl border border-slate-200 bg-slate-50 text-sm font-medium focus:outline-none focus:border-[#008080] focus:ring-1 focus:ring-[#008080]"
                    required
                  >
              ...
              <div className="space-y-2">
                ...
                <textarea 
                  ...
                  className="w-full p-4 rounded-xl border border-slate-200 bg-slate-50 text-sm font-medium focus:outline-none focus:border-[#008080] focus:ring-1 focus:ring-[#008080] min-h-[150px]"
                  placeholder={`Enter details about the interaction with the ${activeMainTab}...`}
                  required
                />
              </div>
              ...
              <button 
                type="submit"
                className="h-12 px-8 rounded-xl bg-[#008080] text-white font-black uppercase text-xs tracking-widest hover:bg-[#006666] transition-all flex items-center justify-center gap-2 w-full md:w-auto"
              >
