           ...
           <div className="flex items-center gap-3 shrink-0">
             ...
             {selectedDate === new Date().toISOString().split('T')[0] && (
               <button
                 ...
                 className={`px-4 py-3 rounded-2xl text-[10px] font-black uppercase tracking-widest flex items-center gap-2 transition-all whitespace-nowrap ${
                   isPaused ? 'bg-amber-100 text-amber-700 hover:bg-amber-200 border border-amber-200' : 'bg-slate-100 text-slate-600 hover:bg-slate-200 border border-slate-200'
                 }`}
               >
