...
const Exams = () => {
 ...
 <td className="px-8 py-6">
 {h.status === 'Completed' ? (
 <span className="text-lg font-black text-[#008080] tracking-tighter ">{h.score}</span>
 ) : (
 <span className="text-[10px] font-black text-amber-600 uppercase ">Rescheduled to {new Date(h.postponed_date).toLocaleDateString()}</span>
 )}
 </td>
 <td className="px-8 py-6">
 ...
 className="w-full p-5 pl-14 bg-slate-50 border border-slate-100 rounded-3xl text-sm font-black focus:bg-white focus:ring-8 ring-[#008080]/5 transition-all outline-none placeholder:font-bold placeholder:opacity-30"
 ...
 className="w-full p-5 pl-14 bg-slate-50 border border-slate-100 rounded-3xl text-sm font-black focus:bg-white focus:ring-8 ring-amber-500/5 transition-all outline-none placeholder:font-bold placeholder:opacity-30"
 ...
 <button
 type="submit"
 className={`w-full py-6 rounded-[2rem] text-[11px] font-black uppercase tracking-[0.3em] shadow-2xl transition-all active:scale-95 flex items-center justify-center gap-4 ${formData.type === 'Complete'
