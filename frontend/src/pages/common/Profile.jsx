...
const ProfileConsole = () => {
 ...
 <div>
 <h4 className="text-lg font-black text-white uppercase mb-2">Protocol Monitoring</h4>
 ...
 <p className="text-[10px] font-black uppercase tracking-widest animate-pulse">Node Status: Nominal</p>
 </div>
 </div>
