...
const StudentLogs = () => {
 ...
 <div>
 <h1 className="text-3xl font-black text-slate-900 tracking-tighter uppercase ">Interaction Logs</h1>
 ...
 <button className="text-[9px] font-black text-[#008080] uppercase tracking-widest flex items-center gap-2 hover:gap-3 transition-all duration-300 group-hover:translate-x-1">
 ...
 <div>
 <h2 className="text-2xl font-black tracking-tight uppercase">Interaction Deep-Dive</h2>
 ...
 <p className="text-xs font-black text-[#008080] uppercase tracking-widest mb-2 ">Confusing Topics:</p>
