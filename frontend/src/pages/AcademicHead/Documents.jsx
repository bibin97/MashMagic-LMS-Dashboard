        ...
        <div className="space-y-10 pb-20 max-w-[1600px] mx-auto animate-in fade-in duration-700">
            ...
            <div className="bg-white p-10 rounded-[3.5rem] shadow-sm border border-slate-100 flex flex-col md:flex-row justify-between items-center gap-6 relative overflow-hidden">
                ...
                <div className="relative z-10 flex items-center gap-6">
                    ...
                    <div>
                        <h1 className="text-3xl font-black text-slate-900 tracking-tighter uppercase italic">Institutional Repository</h1>
                ...
                <div className="relative z-10 flex flex-col sm:flex-row items-center gap-4 w-full md:w-auto">
                    ...
                    <button
                        ...
                        className="w-full sm:w-auto px-10 py-4 bg-slate-900 text-white rounded-2xl text-[10px] font-black uppercase tracking-widest flex items-center justify-center gap-3 hover:bg-emerald-600 transition-all shadow-xl shadow-slate-200 hover:-translate-y-1 active:scale-95 italic"
                    >
            ...
            {loading ? (
                ...
                <div className="bg-white p-32 rounded-[4rem] text-center border-2 border-dashed border-slate-100">
                    ...
                    <h3 className="text-xl font-black text-slate-900 italic uppercase">Repository Void</h3>
                    <p className="text-[10px] font-bold text-slate-400 mt-2 uppercase tracking-[0.2em] leading-loose max-w-sm mx-auto italic">
                    ...
                    {filteredDocs.map((doc) => (
                        <div key={doc.id} className="bg-white rounded-[3rem] p-8 border border-slate-100 shadow-sm hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 group relative overflow-hidden">
                            ...
                            <div className="relative z-10 mb-10">
                                <h3 className="text-2xl font-black text-slate-900 italic uppercase tracking-tighter mb-3 line-clamp-1">{doc.title}</h3>
                                <p className="text-xs text-slate-500 font-bold leading-relaxed italic line-clamp-2">
                            ...
                            <div className="relative z-10 grid grid-cols-2 gap-4 mb-4">
                                ...
                                <div className="flex items-center gap-2 text-[8px] font-black text-slate-400 uppercase tracking-widest italic justify-end">
                            ...
                            <div className="relative z-10 pt-8 border-t border-slate-50 flex items-center gap-4">
                                <a
                                    ...
                                    target="_blank"
                                    rel="noreferrer"
                                    className="flex-1 py-4 bg-slate-50 text-slate-900 rounded-2xl text-[10px] font-black uppercase tracking-widest flex items-center justify-center gap-2 hover:bg-emerald-500 hover:text-white transition-all italic border border-slate-100"
                                >
                    ...
                    <div className="bg-white rounded-[4rem] shadow-2xl w-full max-w-2xl overflow-hidden animate-in zoom-in duration-500 border border-white/20">
                        <div className="bg-slate-900 p-10 flex justify-between items-center relative h-32 overflow-hidden">
                            ...
                            <div className="relative z-10 flex items-center gap-6">
                                ...
                                <h2 className="text-2xl font-black text-white italic uppercase tracking-tight">Asset Ingestion</h2>
                            </div>
                            <button
                        ...
                        <form onSubmit={handleUpload} className="p-12 space-y-8">
                            <div className="space-y-6">
                                <div className="space-y-2">
                                    <label className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] italic">Asset Title</label>
                                    <input
                                        required
                                        type="text"
                                        className="w-full px-8 py-5 bg-slate-50 border border-slate-100 rounded-2xl text-xs font-bold focus:bg-white focus:ring-8 ring-[#008080]/5 outline-none transition-all italic"
                                ...
                                <div className="grid grid-cols-2 gap-6">
                                    <div className="space-y-2">
                                        <label className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] italic">Category</label>
                                        <div className="relative">
                                            <select
                                                className="w-full px-8 py-5 bg-slate-50 border border-slate-100 rounded-2xl text-xs font-bold appearance-none focus:bg-white outline-none transition-all italic"
                                    ...
                                    <div className="space-y-2">
                                        <label className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] italic">File Source (URL)</label>
                                        <input
                                            required
                                            type="text"
                                            className="w-full px-8 py-5 bg-slate-50 border border-slate-100 rounded-2xl text-xs font-bold focus:bg-white focus:ring-8 ring-[#008080]/5 outline-none transition-all italic"
                                ...
                                <div className="space-y-2">
                                    <label className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] italic">Supplied Intelligence (Description)</label>
                                    <textarea
                                        rows="4"
                                        className="w-full px-8 py-5 bg-slate-50 border border-slate-100 rounded-2xl text-xs font-bold focus:bg-white outline-none transition-all resize-none italic"
                            ...
                            <button
                                type="submit"
                                className="w-full py-6 bg-slate-900 text-white rounded-[2rem] text-[10px] font-black uppercase tracking-[0.3em] flex items-center justify-center gap-4 hover:bg-emerald-600 transition-all shadow-xl shadow-slate-200 hover:-translate-y-1 italic"
                            >
